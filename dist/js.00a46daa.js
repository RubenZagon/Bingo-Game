...
var btnComenzar = document.querySelector('.btnBegin');
var btnLanzar = document.querySelector('.btnThrow');
var brdPlayer = document.querySelector('.player');
var brdCPU = document.querySelector('.CPU');
/*
...
var crearArray = function crearArray() {
...
var createCard = function createCard() {
  ...
  var desordenado = crearArray(); // Nos quedamos solo con un array de 15 números

  var seleccion = desordenado.slice(0, 15);
...
var showCard = function showCard(element, card) {
  console.info('Ejecución de la función "showCard');
  card.forEach(function (e) {
    var div = document.createElement('div');
    div.className = "numberBoard number".concat(e);
    div.textContent = "".concat(e);
...
var comenzar = function comenzar() {
  var cartonPlayer = showCard(brdPlayer, createCard());
  var cartonCPU = showCard(brdCPU, createCard()); // Intercambiamos los botones para comenzar el juego y que no se repita el sacar cartones
...
btnComenzar.addEventListener('click', comenzar); ///////////    BOLA CENTRAL     ///////////////////

var bingoDIV = document.querySelector('.bingo');
var btnSacarNumero = document.querySelector('.btnThrow');

var numberBingo = function numberBingo(funcion) {
...
},{}],"C:/Users/Rubén/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Rubén/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
